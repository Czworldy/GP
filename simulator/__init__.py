...
def load(path='/home/cz/CARLA_0.9.9.4'):
    try:
        ...
        # print(glob.glob(path+'/PythonAPI/carla/dist/carla-0.9.9-py3.7-linux-x86_64.egg'))
        sys.path.append(glob.glob(path+'/PythonAPI/carla/dist/carla-0.9.9-py3.7-linux-x86_64.egg')[0])
